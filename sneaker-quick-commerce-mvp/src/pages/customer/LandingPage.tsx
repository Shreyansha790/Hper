...
const features = [
  ...
  },
  {
    icon: <Shield size={20} />,
    title: '100% Authentic',
    desc: 'Every pair is verified and authenticated in-house.',
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 pt-24 pb-16 grid lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div style={{ y: heroY, opacity: heroOpacity }}>
            ...
            >
              ...
              <span className="text-sm font-semibold text-violet-700">Bangalore's Fastest Sneaker Delivery</span>
            </motion.div>
            ...
            >
              Nike. Jordan. Yeezy. New Balance. Get the freshest kicks delivered express from our city warehouses. No waiting, no compromise.
            </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <div>
              ...
              <h2 className="text-4xl font-black text-gray-900">Featured Drops</h2>
            </div>
            <Link to="/shop" className="hidden md:flex items-center gap-1 text-sm font-semibold text-violet-600 hover:text-violet-700 transition-colors">
              View All <ChevronRight size={16} />
            </Link>
